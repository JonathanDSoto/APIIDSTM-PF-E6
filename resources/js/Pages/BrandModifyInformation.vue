            ...
            <div class="card">
                <div class="card-body flex flex-col p-6">
                    <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                        <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white" v-if=$page.props.flag>Modify Brand</div>
                            <div class="card-title text-slate-900 dark:text-white" v-else>Create Brand</div>
                        </div>
                    </header>
                <div class="card-text h-full ">
                    <form class="space-y-4">
                        ...
                        <div class="input-area relative pl-28">
                            ...
                            <input type="number" class="form-control" placeholder="" :value="$page.props.products[5]">
                        </div>
                        <div class="input-area relative pl-28">
                        ...
                        <div class="input-area relative pl-28">
                            ...
                            <input type="image" class="form-control" placeholder="" :value="$page.props.products[4]">
                        </div>
                        <div class="input-area relative pl-28">
        ...
        <div class="xl:col-span-5 col-span-12 lg:col-span-7">
            <div class="card h-full">
                <div class="card-header">
                    <h4 class="card-title" v-if=$page.props.flag >Rules to Modify a Brand</h4>
                    <h4 class="card-title" v-else>Rules to Create a Brand</h4>
                </div>
