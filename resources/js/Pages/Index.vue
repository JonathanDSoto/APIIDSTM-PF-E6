...
<template>
    ...
    <main class="app-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="">
                        <a href="#" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:home" />
                                <span>Dashboard</span>
                            </span>
                            <Icon class="icon-arrow" icon="heroicons-outline:chevron-right" />
                        </a>
                    ...
                    <li>
                        <a href="chat.html" class="navItem">
                            <span class="flex items-center">
                                <Icon class="nav-icon" icon="heroicons-outline:chat" />
                                <span>Chat</span>
                            </span>
                        </a>
                    </li>
                    <li class="">
                        <a href="email.html" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:mail" />
                                <span>Email</span>
                            </span>
                        </a>
                    </li>
                    <li class="">
                        <a href="kanban.html" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:view-boards" />
                                <span>Kanban</span>
                            </span>
                        </a>
                    </li>
                    <li class="">
                        <a href="calander.html" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:calendar" />
                                <span>Calander</span>
                            </span>
                        </a>
                    </li>
                    <li class="">
                        <a href="todo.html" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:clipboard-check" />
                                <span>Todo</span>
                            </span>
                        </a>
                    </li>
                    <li class="">
                        <a href="javascript:void(0)" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:document" />
                                <span>Projects</span>
                            </span>
                            <Icon class="icon-arrow" icon="heroicons-outline:chevron-right" />
                        </a>
                    ...
                    <li class="">
                        <a href="javascript:void(0)" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:lock-closed" />
                    ...
                    <li class="">
                        <a href="javascript:void(0)" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:view-grid-add" />
                                <span>Widgets</span>
                            </span>
                            <Icon class="icon-arrow" icon="heroicons-outline:chevron-right" />
                        </a>
                    ...
                    <li>
                        <a href="javascript:void(0)" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:collection" />
                    ...
                    <li class="">
                        <a href="javascript:void(0)" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:clipboard-list" />
                                <span>Forms</span>
                            </span>
                            <Icon class="icon-arrow" icon="heroicons-outline:chevron-right" />
                        </a>
                    ...
                    <li class="">
                        <a href="javascript:void(0)" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:table" />
                                <span>Tables</span>
                            </span>
                            <Icon class="icon-arrow" icon="heroicons-outline:chevron-right" />
                        </a>
                    ...
                    <li class="">
                        <a href="javascript:void(0)" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:chart-bar" />
                                <span>Chart</span>
                            </span>
                            <Icon class="icon-arrow" icon="heroicons-outline:chevron-right" />
                        </a>
                    ...
                    <li class="">
                        <a href="map.html" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:map" />
                                <span>Map</span>
                            </span>
                        </a>
                    </li>
                    ...
                    <li class="">
                        <a href="icons.html" class="navItem">
                            <span class="flex items-center">
                                <Icon class=" nav-icon" icon="heroicons-outline:emoji-happy" />
                                <span>Icons</span>
                            </span>
                        </a>
                    </li>
        ...
        <button
            ...
            <Icon class="text-slate-50 text-lg animate-spin"
                                ...
                                <ul>
                                    ...
                                    <li class="
                                        ...
                                        <a href="javascript:void()">
                                            <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
                                                <span class="icon-box">
                                                    <Icon icon=heroicons-outline:chip />
                                                </span>
                                    ...
                                    <li class="
                                        ...
                                        <a href="javascript:void()">
                                            <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
                                                <span class="icon-box">
                                                    <Icon icon=heroicons-outline:view-grid-add />
                                                </span>
                                        ...
                                        <ul class="sub-menu">
                                            <li>
                                                <a href=basic-table.html>
                                                    <div class="flex space-x-2 items-start rtl:space-x-reverse">
                                                        <Icon icon=heroicons-outline:table
                                                                      class="leading-[1] text-base" />
                                                        <span class="leading-[1]">
                                                        Basic Table
                                                        </span>
                            ...
                            <div
                                    ...
                                    <div class="dropdown-menu z-10 hidden bg-white divide-y divide-slate-100 shadow w-44 dark:bg-slate-800 border dark:border-slate-900 !top-[29px] rounded-md
                                        ...
                                        <ul class="py-1 text-sm text-slate-800 dark:text-slate-200">
                                            ...
                                            <li>
                                                <a href="#"
                                                   class="flex items-center px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white">
                                                    <Icon icon="emojione:flag-for-germany"
                                                                  class="ltr:mr-2 rtl:ml-2 text-xl" />
                                ...
                                <div>
                                    <button id="themeMood"
                                        ...
                                        <Icon class="text-slate-800 dark:text-white text-xl dark:block hidden"
                                                      id="moonIcon"
                                                      icon="line-md:sunny-outline-to-moon-alt-loop-transition" />
                                        <Icon class="text-slate-800 dark:text-white text-xl dark:hidden block"
                                                      id="sunIcon"
                                ...
                                <div>
                                    <button id="grayScale" class="lg:h-[32px] lg:w-[32px] lg:bg-slate-100 lg:dark:bg-slate-900 dark:text-white text-slate-900 cursor-pointer
                                        ...
                                        <Icon class="text-slate-800 dark:text-white text-xl"
                                ...
                                <div class="relative md:block hidden">
                                    <button class="lg:h-[32px] lg:w-[32px] lg:bg-slate-50 lg:dark:bg-slate-900 dark:text-white text-slate-900 cursor-pointer
                                        rounded-full text-[20px] flex flex-col items-center justify-center" type="button" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                        <Icon class="animate-tada text-slate-800 dark:text-white text-xl"
                                ...
                                <div class="flex justify-between flex-wrap items-center mb-6">
                                    ...
                                    <div
                                        ...
                                        <button
                                            ...
                                            <span class="flex items-center">
                                                <Icon class="text-xl ltr:mr-2 rtl:ml-2 font-light"
