                ...
                <div class="grid grid-cols-12 gap-6">
                  ...
                  <div class="lg:col-span-8 col-span-12">
                                  ...
                                  <div class="overflow-hidden ">
                                    <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                      ...
                                      <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                        <tr v-for="(item, index) in $page.props.userPurchases" :key="index">
                                          <td class="table-td">{{ item[0] }}</td>
                                          <td class="table-td">{{ item[1] }}</td>
                                          <td class="table-td ">
                                            <li v-for="(item, index) in item[2]" :key="index">
                                              {{ item }}
                                            </li>
                                          </td>
                                        </tr>
                    ...
                    <div class="card-body">
                          <div class="card">
                            <header class=" card-header noborder">
                              <h4 class="card-title">Payment History
                              </h4>
                            </header>
                            <div class="card-body px-6 pb-6">
                              <div class="overflow-x-auto -mx-6">
                                <div class="inline-block min-w-full align-middle">
                                  <div class="overflow-hidden ">
                                    <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                      ...
                                      <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                        <tr v-for="(item, index) in $page.props.userPayment" :key="index">
                                          <td class="table-td">{{ item[0] }}</td>
                                          <td class="table-td">{{ item[1] }}</td>
